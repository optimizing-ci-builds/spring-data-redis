...
public class RedisRepositoryConfigurationExtension extends KeyValueRepositoryConfigurationExtension {
	...
	private static final String REDIS_MAPPING_CONFIG_BEAN_NAME = "redis.mapping-cnfig";
	...
	public void registerBeansForRoot(BeanDefinitionRegistry registry, RepositoryConfigurationSource configuration) {
		...
		String indexConfigurationBeanName = BeanDefinitionReaderUtils.uniqueBeanName("redis.index-configuration", registry);
		String keyspaceConfigurationBeanName = BeanDefinitionReaderUtils.uniqueBeanName("redis.keyspace-configuration",
				registry);
